...
<text color="#A3EAFF" type="bold">1.What Is Arch Linux?</text>

So arch linux is A Linux Based Distro, Optimised For Performance, Gaming.

<heading size="1" align="left"></heading>

<text color="#A3EAFF" type="bold">2.Is installation of it not easy.</text>
...
<text color="#A3EAFF" type="bold">3.Can a beginner can install it..</text>

Short Answer is <text color="#A3EAFF" type="bold">YES</text> a beginner can install it, But they have to follow installtion guide wisely.
